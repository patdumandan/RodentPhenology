---
title: "Biotic interactions influence the breeding phenology of desert rodents"
author: "Pat Dumandan"
---
**Introduction**    
...
**Fig.1.** Reproductive phenophase of female (left panel) and male (right panel) Bailey's pocket mouse (*C. baileyi*) in control and exclosure plots from 1996 to 2019.  
...
**Fig.2.** Reproductive phenophase of female (left panel) and male (right panel) desert pocket mouse (*C. penicillatus*) in control and exclosure plots from 1977 to 2019.
...
**Fig.3.** Reproductive phenophase of female (left panel) and male (right panel) Merriam's kangaroo rat (*D. merriami*) in control and exclosure plots from 1977 to 2019.    

*Reproductive phenophases of representative species*  
(first derivatives for the seasonal effects)

*Context-dependent relationships between variables and proportion of breeding individuals*  
...
```{r echo=FALSE}
plot(m5, pages=1, all.terms=TRUE, residuals=TRUE, shade=TRUE)
```
...
```{r echo=FALSE}
plot(m10, pages=1, all.terms=TRUE, residuals=TRUE, shade=TRUE)
```
