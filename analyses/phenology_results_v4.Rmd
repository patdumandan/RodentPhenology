...
m1_bmass2=mgcv::gam(proportion~s(month, bs="cc", k=12)+s(year)+s(ndvi)+s(precipitation)+s(bmass_DM)+
                   s(bmass_PB)+s(bmass_PP), data=PB_male_con, method = 'REML', weights = abundance, family = binomial)
...
m9_bmass=mgcv::gam(proportion~s(month, bs="cc", k=12)+s(year)+s(ndvi)+s(precipitation)+
                     s(bmass_PB)+s(bmass_PP),
                   data=DM_male_con, method = 'REML', weights = abundance, family = binomial)

summary(m9_bmass) #R2=21%
