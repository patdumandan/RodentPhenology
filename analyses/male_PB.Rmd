...
#### simple logistic regression (intercept only)  
...
#### logistic regression with year and trt
```{r warning=FALSE, message=FALSE, echo=FALSE}
...
#### logistic regression with year and trt and month as circular var
```{r warning=FALSE, message=FALSE, echo=FALSE}
PB_dat_M$trt<-ifelse(PB_dat_M$treatment=="control", 0, 1) 
PB_dat_M$years=(PB_dat_M$year-mean(PB_dat_M$year))/(2*sd(PB_dat_M$year)) #standardize year
PB_dat_M$month=as.character(PB_dat_M$month)
...
#### hierarchical logistic regression with year and trt as covar and month as random intercept
```{r warning=FALSE, message=FALSE, echo=FALSE}
PB_dat_M$trt<-ifelse(PB_dat_M$treatment=="control", 0, 1) 
PB_dat_M$years=(PB_dat_M$year-mean(PB_dat_M$year))/(2*sd(PB_dat_M$year)) #standardize year
