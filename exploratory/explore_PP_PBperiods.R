...
ppm_ex3_mid=mgcv::gam(proportion~s(month,bs="cc")+year+ndvis+ndvis_lag+temps_mean+
...
ppf_ex3_mid=mgcv::gam(proportion~s(month,bs="cc")+year+ndvis+ndvis_lag+temps_mean+
                        temps_lag_mean+ppts_warm+ppts_lag_warm+ppts_cool+ppts_lag_cool+
                        pps+dipos+pbs, 
                      data=ppf_ex_mid, method = 'REML', 
                      weights = abundance, family = binomial)
summary(ppf_ex3_mid)


#PP male and female (pre-PB)####
plot(ppm_ex_pre$proportion~ppm_ex_pre$month, col="blue", pch=19, ylab="proportion", xlab="month")
points(ppf_ex_pre$proportion~ppf_ex_pre$month, col="green", pch=19)

#PP male and females (post-PB)####
plot(ppm_ex_mid$proportion~ppm_ex_mid$month, col="blue", pch=19, ylab="proportion", xlab="month")
points(ppf_ex_mid$proportion~ppf_ex_mid$month, col="green", pch=19)

#PP male and females (post-PB)####
plot(ppm_ex_post$proportion~ppm_ex_post$month, col="blue", pch=19, ylab="proportion", xlab="month")
points(ppf_ex_post$proportion~ppf_ex_post$month, col="green", pch=19)
