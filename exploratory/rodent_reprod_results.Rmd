...
Table 1. Model evaluation results. Deviance explained (adj.R2) of different models fitted to determine the drivers of reproduction of PB males and females in control and exclosure plots   


```{r echo=F, fig.show="hold",out.width="50%", fig.cap="Table 1. Model evaluation results.Deviance explained (adj.R2) of different variations of the models fitted to describe reproductive events of PB males and females"}
pbm=matrix(c("18.2(0.11)","18.5(0.10)", "21.8(0.17)", "38.1(0.37)","40.8(0.39)", "44.3(0.42)"), ncol=2, byrow=F)
colnames(pbm)=c("PB male control", "PB male exclosure")
rownames(pbm)=c("abiotic only", "abiotic+intraspecific competition", "abiotic+intra+interspecific competition")
pbm=as.table(pbm)
pbm

pbf=matrix(c("66.9(0.56)","66.2(0.57)", "66.4(0.57)", "66.7(0.65)","66.7(0.65)", "69.3(0.66)"), ncol=2, byrow=F)
colnames(pbf)=c("PB female control", "PB female exclosure")
rownames(pbf)=c("abiotic only", "abiotic+intraspecific competition", "abiotic+intra+interspecific competition")
pbf=as.table(pbf)
pbf
...
Table 2. Model evaluation results. Deviance explained (adj.R2) of different models fitted to determine the drivers of reproduction of PP males and females in control and exclosure plots  


```{r echo=F, fig.show="hold",out.width="50%", fig.cap="Table 2. Model evaluation results.Deviance explained (adj.R2) of different variations of the models fitted to describe reproductive events of PP males and females"}
ppm=matrix(c("62.2(0.64)","62.4(0.65)", "63.6(0.68)", "51.9(0.49)","52(0.49)", "52.1(0.48)"), ncol=2, byrow=F)
colnames(ppm)=c("PP male control", "PP male exclosure")
rownames(ppm)=c("abiotic only", "abiotic+intraspecific competition", "abiotic+intra+interspecific competition")
ppm=as.table(ppm)
ppm

ppf=matrix(c("52.5(0.50)","50.6(0.49)", "55.5(0.53)", "46.6(0.40)","47.6(0.41)", "50.4(0.44)"), ncol=2, byrow=F)
colnames(ppf)=c("PP female control", "PP female exclosure")
rownames(ppf)=c("abiotic only", "abiotic+intraspecific competition", "abiotic+intra+interspecific competition")
ppf=as.table(ppf)
ppf
```  
